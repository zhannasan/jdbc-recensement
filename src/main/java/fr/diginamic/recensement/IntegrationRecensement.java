...
/**
 * Lecture de fichier .csv, création si necessaire des tables ville, departement
 * région, et integration des données dans la base de données locale recensement
 *
 */
